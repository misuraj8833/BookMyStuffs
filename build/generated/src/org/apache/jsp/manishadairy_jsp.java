...
public final class manishadairy_jsp extends org.apache.jasper.runtime.HttpJspBase
            ...
            String username =sess.getAttribute("username").toString();
                ...
                while(rs.next()){
                    ...
                    out.print("<input type='hidden' name='shop' value='manishadairy'>");
                     ...
                     out.print("<td> <input type='number' name='qauntity' max="+max+" min=0 step=0.01></td>");
